    ...
    *,
    ...
    return {
        ...
        "pose3d": {
            ...
            "has_root_translation": bool(pose_sequence_3d.root_translation_m is not None),
        },
        ...
        "root_trajectory_quality_report": dict(pipeline_result.get("root_trajectory_quality_report", {})),
        "artifacts": artifacts,
    }
    ...
    *,
    ...
    return {
        ...
        "artifacts": {
            ...
            "pose3d_metric_local_npz_path": str((pose_dir / "pose3d_metric_local.npz").resolve()) if (pose_dir / "pose3d_metric_local.npz").exists() else None,
            ...
            "root_translation_npy_path": str((pose_dir / "root_translation.npy").resolve()) if (pose_dir / "root_translation.npy").exists() else None,
